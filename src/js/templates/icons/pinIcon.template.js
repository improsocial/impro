...
// Source: https://github.com/halfmage/majesticons/blob/main/line/pin-line.svg
export function pinIconTemplate({ filled = false } = {}) {
  return html`<div class=${classnames("icon pin-icon", { filled })}>
    ${filled
      ? html`<svg
