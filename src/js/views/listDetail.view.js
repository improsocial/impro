...
export default async function listDetailView({
  root,
  params,
  context: {
    dataLayer,
    ...
    render(
      html`<div id="list-detail-view">
        ...
        ${!list
          ...
          : html`<main>
              <div class="list-detail-header" data-testid="list-detail-header">
                ${list.avatar
                  ? html`<img
                ...
                <div class="list-detail-header-text">
                  <div class="list-detail-name" data-testid="list-detail-name">
                    ${list.name}
                  </div>
                  ${listCreator
                    ? html`<div
