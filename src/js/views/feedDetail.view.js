...
export default async function feedDetailView({
  root,
  params,
  context: {
    dataLayer,
  ...
  bindPageTitle(root, () => {
    return dataLayer.derived.$feedGenerators.get(feedUri)?.displayName ?? null;
  });
  ...
  async function loadPageData() {
    dataLayer.requests.loadFeedGenerator(feedUri);
