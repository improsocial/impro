...
export default async function settingsAdvancedView({
  ...
  router,
  layout,
  context: { auth, pluginService, pushNotificationService },
}) {
  ...
  pageEffect(root, () => {
    ...
    render(
      html`<div id="settings-advanced-view">
        ...
        <main>
          <form id="settings-advanced-form" @submit=${(e) => handleSubmit(e)}>
            <section class="settings-section">
              <h2>App View</h2>
              <p>
                Choose which App View (backend) to use for fetching content.
                Tip: You can use the query parameter ?reset-appview to reset the
                App View in case of misconfiguration.
              </p>
